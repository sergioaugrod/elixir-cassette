defmodule Cassette.Client.GenerateSt do
  ...
  def perform(config = %Cassette.Config{base_url: base_url}, tgt, service) do
    case post("#{base_url}/v1/tickets/#{tgt}", {:form, [service: service]}, [], Cassette.Client.options(config)) do
